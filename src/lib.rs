...
mod tests {
    ...
    fn test_translate_to_pig_latin() {
        ...
        // examples:
        assert_eq!( String::from("atinlay"), super::translate_to_pig_latin( super::OriginalWord{ word: String::from("latin") } ));
        ...
        assert_eq!( String::from("eshshay"), super::translate_to_pig_latin( super::OriginalWord{ word: String::from("cheers") } ));
        ...
        assert_eq!( String::from("omeletay"), super::translate_to_pig_latin( super::OriginalWord{ word: String::from("omelete") } ));
